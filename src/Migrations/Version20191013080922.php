 ...
 */
final class Version20191013080922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE conversions DROP FOREIGN KEY FK_6A02DBA5F347EFB');
        $this->addSql('DROP INDEX IDX_6A02DBA5F347EFB ON conversions');
        $this->addSql('ALTER TABLE conversions DROP produit_id, CHANGE produits_id produits_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE conversions ADD produit_id INT DEFAULT NULL, CHANGE produits_id produits_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE conversions ADD CONSTRAINT FK_6A02DBA5F347EFB FOREIGN KEY (produit_id) REFERENCES unites (id)');
        $this->addSql('CREATE INDEX IDX_6A02DBA5F347EFB ON conversions (produit_id)');
        ...
        $this->addSql('ALTER TABLE stocks DROP reference, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE piece_id piece_id INT DEFAULT NULL, CHANGE validation_id validation_id INT DEFAULT NULL, CHANGE validateur_id validateur_id INT DEFAULT NULL, CHANGE stock_id stock_id INT DEFAULT NULL, CHANGE autre_source_id autre_source_id INT DEFAULT NULL, CHANGE date_validation date_validation DATETIME DEFAULT \'NULL\', CHANGE site site VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE user CHANGE access_id access_id INT DEFAULT NULL');
