...
class StocksController extends AbstractController
{
     ...
     */
    public function index(StocksRepository $stocksRepository, Request $request, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $stocksRepository->findAll(), /* query NOT result */
