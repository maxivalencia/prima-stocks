...
class ClientsController extends AbstractController
{
     ...
     */
    public function index(ClientsRepository $clientsRepository, Request $request, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $clientsRepository->findAll(), /* query NOT result */
